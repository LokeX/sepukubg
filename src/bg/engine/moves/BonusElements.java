...
public class BonusElements extends MoveLayout implements Serializable {
  ...
  public int stacBonusMaxContact = 4;//  range 3-6
  public int stacBonusNoContactDivisor = 2;//  range 1-5
  ...
  public int homeCommingBonusChekkersQuadrantsAwayMultiplier = 1;//  range 1-2
  public int homeCommingBonusRearHomePointMulitplierReducer = -2;//  range 0 - -3
  public int homeCommingBonusBonusCounter = 7;//  range 5-9
  public int HomeCommingBaseBonus = 10;//  range 5-15
  public int homeCommingBonusVacantPointEqualizer = 5;//  range 3-8
  public int checkingOutBonusThreeChekkersLeftBaseBonus = 20;//  range 15-25
  public int checkingOutBonusFourChekkersLeftBaseBonus = 10;//  range 5-15
  ...
  public int bestDiceBonusMulitplier = 10;//  range 7 - 14
...
//    stacBonusMaxContact = ran.nextInt(4)+3;//  range 3-6
    stacBonusMaxContact = 4;//  range 3-6
//    stacBonusNoContactDivisor = ran.nextInt(5)+1;//  range 1-5
    stacBonusNoContactDivisor = 2;//  range 1-5
...
//    homeCommingBonusChekkersQuadrantsAwayMultiplier = ran.nextInt(2)+1;//  range 1-2
    homeCommingBonusChekkersQuadrantsAwayMultiplier = 1;//  range 1-2
//    homeCommingBonusRearHomePointMulitplierReducer = ran.nextInt(4)*-3;//  range 0 - -3
    homeCommingBonusRearHomePointMulitplierReducer = -2;//  range 0 - -3
//    homeCommingBonusBonusCounter = ran.nextInt(5)+5;//  range 5-9
    homeCommingBonusBonusCounter = 7;//  range 5-9
//    HomeCommingBaseBonus = ran.nextInt(11)+5;//  range 5-15
    HomeCommingBaseBonus = 10;//  range 5-15
//    homeCommingBonusVacantPointEqualizer = ran.nextInt(6)+3;//  range 3-8
    homeCommingBonusVacantPointEqualizer = 5;//  range 3-8
//    checkingOutBonusThreeChekkersLeftBaseBonus = ran.nextInt(11)+15;//  range 15-25
    checkingOutBonusThreeChekkersLeftBaseBonus = 20;//  range 15-25
//    checkingOutBonusFourChekkersLeftBaseBonus = ran.nextInt(11)+15;//  range 5-15
    checkingOutBonusFourChekkersLeftBaseBonus = 10;//  range 5-15
...
//    bestDiceBonusMulitplier = ran.nextInt(8)+7;//  range 7 - 14
    bestDiceBonusMulitplier = 10;//  range 7 - 14
...
//    potentialHitBonusTurnDivisor = ran.nextInt(6)+6;//  range 6 - 11
  ...
  public void setElements (BonusElements elements) {
    ...
    stacBonusMaxContact = elements.stacBonusMaxContact;
    stacBonusNoContactDivisor = elements.stacBonusNoContactDivisor;
    ...
    homeCommingBonusChekkersQuadrantsAwayMultiplier = elements.homeCommingBonusChekkersQuadrantsAwayMultiplier;
    homeCommingBonusRearHomePointMulitplierReducer = elements.homeCommingBonusRearHomePointMulitplierReducer;
    homeCommingBonusBonusCounter = elements.homeCommingBonusBonusCounter;
    HomeCommingBaseBonus = elements.HomeCommingBaseBonus;
    homeCommingBonusVacantPointEqualizer = elements.homeCommingBonusVacantPointEqualizer;
    checkingOutBonusThreeChekkersLeftBaseBonus = elements.checkingOutBonusThreeChekkersLeftBaseBonus;
    checkingOutBonusFourChekkersLeftBaseBonus = elements.checkingOutBonusFourChekkersLeftBaseBonus;
    ...
    bestDiceBonusMulitplier = elements.bestDiceBonusMulitplier;
